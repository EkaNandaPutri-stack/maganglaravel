    ...
    <main class="page">
        <section class="panel">
            ...
            <form action="{{ $formAction }}" method="POST" enctype="multipart/form-data">
                ...
                <input id="nama_kegiatan" name="nama_kegiatan" type="text" value="{{ old('nama_kegiatan', $kegiatan->nama_kegiatan) }}" required>

                <label for="deskripsi">Deskripsi</label>
                <textarea id="deskripsi" name="deskripsi">{{ old('deskripsi', $kegiatan->deskripsi) }}</textarea>

                <label for="tanggal">Tanggal</label>
                <input id="tanggal" name="tanggal" type="date" value="{{ old('tanggal', $kegiatan->tanggal?->format('Y-m-d')) }}" required>

                <label for="lokasi">Lokasi</label>
                <input id="lokasi" name="lokasi" type="text" value="{{ old('lokasi', $kegiatan->lokasi) }}">

                <label for="gambar">Foto Kegiatan (opsional)</label>
                ...
                @if ($kegiatan->gambar)
                    <p>Foto saat ini: {{ basename($kegiatan->gambar) }}</p>
                @endif

                <div class="actions">
                    <a class="button secondary" href="{{ route('admin.kegiatan.index') }}">Batal</a>
                    <button class="button" type="submit">Simpan Kegiatan</button>
                </div>
            </form>
        </section>
    </main>
